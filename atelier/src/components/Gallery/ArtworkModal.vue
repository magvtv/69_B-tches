            ...
            <div class="relative border border-border shadow-renaissance" :style="{ transform: `scale(${zoomLevel})` }">
              ...
              <AntiScrapeLayer protection-level="advanced">
                <div class="absolute bottom-4 right-4 flex gap-2">
                  <button class="w-9 h-9 rounded-full bg-black/50 border border-primary text-primary flex items-center justify-center transition-all duration-300 hover:bg-primary hover:text-background-primary" @click.stop="zoomIn">+</button>
                  <button class="w-9 h-9 rounded-full bg-black/50 border border-primary text-primary flex items-center justify-center transition-all duration-300 hover:bg-primary hover:text-background-primary" @click.stop="zoomOut">-</button>
                </div>
              </AntiScrapeLayer>
            </div>
          </div>
