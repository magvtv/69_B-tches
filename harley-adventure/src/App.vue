      ...
      <main class="max-w-6xl mx-auto p-6">
        ...
        <div v-if="currentLevel === 0" class="text-center text-white">
          <div class="bg-black/20 backdrop-blur-sm rounded-lg p-8 mb-6">
            <h2 class="text-4xl font-bold mb-4">🌟 Welcome to Your Adventure, Harley 🌟</h2>
...
// IP restriction - Replace with Harley's actual IP
const authorizedIPs = [
  '127.0.0.1', // localhost for development
  '197.232.81.136', // Your current IP address
  // Add Harley's actual IP here when you know it
]
...
onMounted(async () => {
  ...
  timeInterval = setInterval(() => {
    ...
    // Update tracking service with session time
